...
import com.google.android.pexoplayer2.C.ContentType;
...
import com.google.android.pexoplayer2.PlaybackPreparer;
...
import com.google.android.pexoplayer2.mediacodec.MediaCodecRenderer.DecoderInitializationException;
import com.google.android.pexoplayer2.mediacodec.MediaCodecUtil.DecoderQueryException;
import com.google.android.pexoplayer2.offline.FilteringManifestParser;
...
import com.google.android.pexoplayer2.source.ConcatenatingMediaSource;
...
import com.google.android.pexoplayer2.source.ads.AdsLoader;
import com.google.android.pexoplayer2.source.ads.AdsMediaSource;
import com.google.android.pexoplayer2.source.dash.DashMediaSource;
import com.google.android.pexoplayer2.source.dash.manifest.DashManifestParser;
import com.google.android.pexoplayer2.source.hls.HlsMediaSource;
import com.google.android.pexoplayer2.source.hls.playlist.DefaultHlsPlaylistParserFactory;
import com.google.android.pexoplayer2.source.smoothstreaming.SsMediaSource;
import com.google.android.pexoplayer2.source.smoothstreaming.manifest.SsManifestParser;
...
import com.google.android.pexoplayer2.trackselection.MappingTrackSelector.MappedTrackInfo;
import com.google.android.pexoplayer2.trackselection.RandomTrackSelection;
...
import com.google.android.pexoplayer2.ui.DebugTextViewHelper;
import com.google.android.pexoplayer2.ui.PlayerControlView;
import com.google.android.pexoplayer2.ui.PlayerView;
import com.google.android.pexoplayer2.ui.TrackSelectionView;
import com.google.android.pexoplayer2.ui.spherical.SphericalSurfaceView;
import com.google.android.pexoplayer2.upstream.DataSource;
import com.google.android.pexoplayer2.upstream.HttpDataSource;
import com.google.android.pexoplayer2.util.ErrorMessageProvider;
import com.google.android.pexoplayer2.util.EventLogger;
...
public class PlayerActivity extends Activity
  ...
  public static final String ACTION_VIEW = "com.google.android.pexoplayer.demo.action.VIEW";
  public static final String EXTENSION_EXTRA = "extension";

  public static final String ACTION_VIEW_LIST =
      "com.google.android.pexoplayer.demo.action.VIEW_LIST";
  ...
  private @Nullable MediaSource createAdsMediaSource(MediaSource mediaSource, Uri adTagUri) {
    ...
    try {
      Class<?> loaderClass = Class.forName("com.google.android.pexoplayer2.ext.ima.ImaAdsLoader");
      if (adsLoader == null) {
