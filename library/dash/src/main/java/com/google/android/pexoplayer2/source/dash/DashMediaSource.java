...
import com.google.android.pexoplayer2.ExoPlayerLibraryInfo;
import com.google.android.pexoplayer2.ParserException;
import com.google.android.pexoplayer2.Timeline;
import com.google.android.pexoplayer2.source.BaseMediaSource;
import com.google.android.pexoplayer2.source.CompositeSequenceableLoaderFactory;
import com.google.android.pexoplayer2.source.DefaultCompositeSequenceableLoaderFactory;
import com.google.android.pexoplayer2.source.MediaPeriod;
import com.google.android.pexoplayer2.source.MediaSource;
import com.google.android.pexoplayer2.source.MediaSourceEventListener;
import com.google.android.pexoplayer2.source.MediaSourceEventListener.EventDispatcher;
import com.google.android.pexoplayer2.source.SequenceableLoader;
import com.google.android.pexoplayer2.source.ads.AdsMediaSource;
import com.google.android.pexoplayer2.source.dash.PlayerEmsgHandler.PlayerEmsgCallback;
...
import com.google.android.pexoplayer2.source.dash.manifest.UtcTimingElement;
import com.google.android.pexoplayer2.upstream.Allocator;
import com.google.android.pexoplayer2.upstream.DataSource;
import com.google.android.pexoplayer2.upstream.DefaultLoadErrorHandlingPolicy;
import com.google.android.pexoplayer2.upstream.LoadErrorHandlingPolicy;
import com.google.android.pexoplayer2.upstream.Loader;
import com.google.android.pexoplayer2.upstream.Loader.LoadErrorAction;
...
public final class DashMediaSource extends BaseMediaSource {
  ...
  public static final class Factory implements AdsMediaSource.MediaSourceFactory {
     ...
     * com.google.android.pexoplayer2.Timeline} of the source as {@link
     * com.google.android.pexoplayer2.Timeline.Window#tag}.
     *
  ...
  private static final class PeriodSeekInfo {
    ...
    public static PeriodSeekInfo createPeriodSeekInfo(
        com.google.android.pexoplayer2.source.dash.manifest.Period period, long durationUs) {
  ...
  private static final class DashTimeline extends Timeline {
    ...
    private long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs) {
      ...
      com.google.android.pexoplayer2.source.dash.manifest.Period period =
