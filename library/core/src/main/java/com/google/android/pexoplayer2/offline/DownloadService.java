...
import com.google.android.pexoplayer2.scheduler.Requirements;
import com.google.android.pexoplayer2.scheduler.RequirementsWatcher;
...
public abstract class DownloadService extends Service {
  ...
  public static final String ACTION_INIT =
      "com.google.android.pexoplayer.downloadService.action.INIT";

  /** Starts a download service, adding a new {@link DownloadAction} to be executed. */
  public static final String ACTION_ADD = "com.google.android.pexoplayer.downloadService.action.ADD";

  /** Reloads the download requirements. */
  public static final String ACTION_RELOAD_REQUIREMENTS =
      "com.google.android.pexoplayer.downloadService.action.RELOAD_REQUIREMENTS";

  /** Like {@link #ACTION_INIT}, but with {@link #KEY_FOREGROUND} implicitly set to true. */
  private static final String ACTION_RESTART =
      "com.google.android.pexoplayer.downloadService.action.RESTART";
