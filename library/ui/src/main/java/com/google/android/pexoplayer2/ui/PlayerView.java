...
import com.google.android.pexoplayer2.ControlDispatcher;
import com.google.android.pexoplayer2.DefaultControlDispatcher;
...
import com.google.android.pexoplayer2.Player.VideoComponent;
import com.google.android.pexoplayer2.metadata.Metadata;
import com.google.android.pexoplayer2.metadata.id3.ApicFrame;
...
import com.google.android.pexoplayer2.ui.AspectRatioFrameLayout.ResizeMode;
import com.google.android.pexoplayer2.ui.spherical.SingleTapListener;
...
import com.google.android.pexoplayer2.video.VideoListener;
 ...
 *       <ul>
 *         <li>Corresponding method: None
 *         <li>Default: {@code R.layout.pexo_player_view}
 *       </ul>
 ...
 * you can define {@code pexo_player_view.xmll} layout files in your application {@code res/layout*}
 ...
 *
 * Defining your own {@code pexo_player_view.xmll} is useful to customize the layout of PlayerView
 ...
 * pexo_player_vieww.xml} for only the instance on which the attribute is set.
 */
public class PlayerView extends FrameLayout implements AdsLoader.AdViewProvider {
  ...
  public PlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    int shutterColor = 0;
    int playerLayoutId = R.layout.pexo_player_view;
