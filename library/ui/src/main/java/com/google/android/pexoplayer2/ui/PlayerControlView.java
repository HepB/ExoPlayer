...
import com.google.android.pexoplayer2.util.RepeatModeUtil;
 ...
 *         <li>Default: {@code R.layout.pexo_player_control_view}
 *       </ul>
 * </ul>
 *
 ...
 * configurations, you can define {@code pexo_player_control_vieww.xml} layout files in your
 ...
 *
 * Defining your own {@code pexo_player_control_vieww.xml} is useful to customize the layout of
 ...
 * {@code pexo_player_control_vieww.xml} for only the instance on which the attribute is set.
 */
public class PlayerControlView extends FrameLayout {
  ...
  private com.google.android.pexoplayer2.ControlDispatcher controlDispatcher;
  ...
  public PlayerControlView(
    ...
    int controllerLayoutId = R.layout.pexo_player_control_view;
    ...
    controlDispatcher = new com.google.android.pexoplayer2.DefaultControlDispatcher();
    ...
    durationView = findViewById(R.id.pexo_duration);
    positionView = findViewById(R.id.pexo_position);
    timeBar = findViewById(R.id.pexo_progress);
    if (timeBar != null) {
      timeBar.addListener(componentListener);
    }
    playButton = findViewById(R.id.pexo_play);
    if (playButton != null) {
      playButton.setOnClickListener(componentListener);
    }
    pauseButton = findViewById(R.id.pexo_pause);
    if (pauseButton != null) {
      pauseButton.setOnClickListener(componentListener);
    }
    previousButton = findViewById(R.id.pexo_prev);
    if (previousButton != null) {
      previousButton.setOnClickListener(componentListener);
    }
    nextButton = findViewById(R.id.pexo_next);
    if (nextButton != null) {
      nextButton.setOnClickListener(componentListener);
    }
    rewindButton = findViewById(R.id.pexo_rew);
    if (rewindButton != null) {
      rewindButton.setOnClickListener(componentListener);
    }
    fastForwardButton = findViewById(R.id.pexo_ffwd);
    if (fastForwardButton != null) {
      fastForwardButton.setOnClickListener(componentListener);
    }
    repeatToggleButton = findViewById(R.id.pexo_repeat_toggle);
    if (repeatToggleButton != null) {
      repeatToggleButton.setOnClickListener(componentListener);
    }
    shuffleButton = findViewById(R.id.pexo_shuffle);
  ...
  /**
   * Sets the {@link com.google.android.pexoplayer2.ControlDispatcher}.
   *
   * @param controlDispatcher The {@link com.google.android.pexoplayer2.ControlDispatcher}, or null
   *     to use {@link com.google.android.pexoplayer2.DefaultControlDispatcher}.
   */
  public void setControlDispatcher(
      @Nullable com.google.android.pexoplayer2.ControlDispatcher controlDispatcher) {
    this.controlDispatcher =
        controlDispatcher == null
            ? new com.google.android.pexoplayer2.DefaultControlDispatcher()
            : controlDispatcher;
  }
